...
// ⚠️ This resets whenever the server restarts — for production use, consider Redis or another store.
...
export async function POST(request: NextRequest) {
  ...
  try {
    // ✅ Correct way to get client IP (NextRequest has no `ip` property)
    const ip =
