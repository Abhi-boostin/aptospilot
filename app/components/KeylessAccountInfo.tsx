...
interface KeylessAccountInfoProps {
  address: string;
  publicKey: string;
  balance: string;
}

export default function KeylessAccountInfo({ address, publicKey, balance }: KeylessAccountInfoProps) {
  return (
    <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          <h3 className="text-sm font-medium text-gray-500 mb-1">Public Key</h3>
